...
const Footer = ({ onRouteChange, onSubsChange, onSumbitSubscription }) => {
return (
    ...
    <div className="flex flex-wrap justify-content items-center center pv5 w-100-l" >
      ...
      <div className="flex flex-column w-50-l center  items-center">
        <div className="artbgtext pa3">
          ...
          <p className="f3-l f5 center " >Cuéntanos tu proyecto.
          </p>
        </div>
        <div className=" tc ">
          <img
  ...
  <div className="vh-25-l o-50">
    ...
    <div className="flex flex-wrap  items-center justify-center  mt4">
      ...
      <div className="flex flex-column w-50-l center">
          ...
          <form className="flex flex-column justify-center center tl-l tc">
            <h1 className="f1-l f2 ma0  lh-solid">Subscribete</h1>
            <p className="f3-l f5  ">Descubre nuestros artículos.</p>

            <div className="">
             <input
                  onChange = {onSubsChange}
                  className=" br2 input-reset ba b--white br2 h2 f4"
                  type="email"
                  name="email"
                  id="email"
                  placeholder="Email@mail.com"
                  required
                //  value= {onEmailChange.signInEmail}
                  />
            </div>

            <div className="pt4">
                 <input
                  onClick = {onSumbitSubscription}
                  className=" f3  tracked-tight dib  pv2 br2 ph4 ba ph4 color-boton grow "
                  type="submit"
                  value="ENVIAR"/>
            </div>
          </form>
      ...
      <div className="flex flex-column w-50-l center">
          ...
          <article className="fl w-50 dib-ns w-auto-ns  mt4 tc">
            ...
            <a target="_blank"  rel="noopener noreferrer" className="link hover-silver near-white dib mh3 tc" href="https://linkedin.com/company/itresseai" title="LinkedIn">
